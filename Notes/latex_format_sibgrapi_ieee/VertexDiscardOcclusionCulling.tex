...
With this metric we can determine the percentage of discarded meshes that were not sent to the GPU in each frame due to occlusion culling (see results in \figref{discarded_objects_percent}).\
