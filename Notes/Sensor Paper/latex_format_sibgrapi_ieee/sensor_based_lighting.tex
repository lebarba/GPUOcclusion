...
%
The technique presented in this work consists in positioning virtual cameras in selected visible points of the scene, \figref{algorithm_overview}.
...
In our tests, we achieved a good compromise between quality and performance with a \emph{sensor map} of $256 \times 256$, \figref{sensor_area}.
