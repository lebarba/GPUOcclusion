...
namespace Examples.GpuOcclusion.ParalellOccludee
{
    ...
    /// DemoCiudadArriba
    /// </summary>
    public class DemoCiudadArribaScreenshot : TgcExample
    {
        ...
        /// </summary>
        private void updateRemoteMesh(float elapsedTime)
        {
            ...
            else
            {
                ...
                Vector3 fpsPos = remoteMesh.Position + new Vector3(0, /*10*/50, 0);
                ...
                Vector3 fpsLookAt = fpsPos + remoteMeshLookAtVec * 10f;
        ...
        private void updateVisibility(Device d3dDevice)
        {
            ...
            if (freeCameraEnabled)
            {
                vMatrix = GuiController.Instance.FpsCamera.ViewMatrix;
            }
            else
            {
                vMatrix = thirdPersonView;
            }
            ...
            d3dDevice.Transform.View = vMatrix;
        }
